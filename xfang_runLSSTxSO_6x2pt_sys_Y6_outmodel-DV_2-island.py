...
data=['6x2pt_LSSTxSO_Y1_dmo_outmodel','6x2pt_LSSTxSO_Y6_dmo_outmodel']
...
chain_file = os.path.join(dirname, "chains/LSSTxSO_6x2pt_outlier_model-DV_2-islands_%d" %model)
