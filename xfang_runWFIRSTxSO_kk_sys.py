...
inv=['invcov_wfirstwidexso_kk','invcov_Y6_6x2pt']

data=['kk_WFIRSTwidexSO5_dmo','6x2pt_LSSTxSO_Y6_dmo']

bary=['LPC_kk_WFIRSTwidexSO5','LPC_6x2pt_LSSTxSO_Y6']
...
sample_params = sample_cosmology_kk_allsys()

sample_main_kk(sample_params,8000,1120,1,chain_file, blind=False, pool=MPIPool())
