...
data=['6x2pt_LSSTxSO_Y1_1sample_dmo_outext_2-island','6x2pt_LSSTxSO_Y6_1sample_dmo_outext_2-island']
...
chain_file = os.path.join(dirname, "chains/LSSTxSO_6x2pt_outlier_model-DV_2-islands_%d_1sample" %model)
