...
inv=['invcov_Y1_6x2pt_12Mpc','invcov_Y6_6x2pt_12Mpc']

data=['6x2pt_LSSTxSO_Y1_dmo_12Mpc','6x2pt_LSSTxSO_Y6_dmo_12Mpc']
...
chain_file = os.path.join(dirname, "chains/LSSTxSO_6x2pt_model_%d_12Mpc" %model)
...
initbins(15,20.0,3000.0,3000.0,12.0,10,10)
