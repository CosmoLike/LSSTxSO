...
inv=['invcov_Y1_5x2pt','invcov_Y6_5x2pt']

data=['5x2pt_LSSTxSO_Y1_dmo','5x2pt_LSSTxSO_Y6_dmo']

bary=['LPC_5x2pt_LSSTxSO_Y1','LPC_5x2pt_LSSTxSO_Y6']
...
chain_file = os.path.join(dirname, "chains/LSSTxSO_5x2pt_MG_model_%d" %model)
