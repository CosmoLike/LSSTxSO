...
from cosmolike_libs_LSSTxSO_outmodel import * 
from schwimmbad import MPIPool

inv=['invcov_Y1_6x2pt','invcov_Y6_6x2pt']

data=['6x2pt_LSSTxSO_Y1_dmo_outext_2-island','6x2pt_LSSTxSO_Y6_dmo_outext_2-island']
...
chain_file = os.path.join(dirname, "chains/LSSTxSO_6x2pt_outlier_model_2-islands_%d_DV2-island" %model)
