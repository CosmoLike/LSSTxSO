...
/* here, do your time-consuming job */
  ...
  char source_zfile[2][400]={"src_LSSTY1ext_2-island","src_LSSTY6ext_2-island"};
#ifdef ONESAMPLE
  char lens_zfile[2][400]={"src_LSSTY1ext_2-island","src_LSSTY6ext_2-island"};
...
#else
  char lens_zfile[2][400]={"lens_LSSTY1ext_2-island", "lens_LSSTY6ext_2-island"};
...
#ifdef ONESAMPLE
  sprintf(arg3,"%s_1sample_%s_outext_2-island",survey_designation[sce],argv[2]);
#else
  sprintf(arg3,"%s_%s_outext_2-island",survey_designation[sce],argv[2]);
#endif
