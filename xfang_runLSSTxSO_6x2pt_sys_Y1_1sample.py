...
data=['6x2pt_LSSTxSO_Y1_1sample_dmo','6x2pt_LSSTxSO_Y6_1sample_dmo']
...
chain_file = os.path.join(dirname, "chains/LSSTxSO_6x2pt_model_%d_1sample" %model)
...
sample_main_1sample(sample_params,sigma_z_shear[model],sigma_z_clustering[model],8000,Nwalker,1,chain_file, blind=False, pool=MPIPool())
