...
/* here, do your time-consuming job */
  ...
  double sigma_zphot_shear[3]={0.02,0.01};
  double sigma_zphot_clustering[3]={0.02,0.01};
  ...
  char survey_designation[2][200]={"WFIRSTwidexSO5","WFIRSTstdxSO5"};
  ...
  char tomo_binning_lens[2][200]={"WF_SN10","WF_SN10"};

  char source_zfile[2][400]={"zdistri_WFIRST_LSST_lensing_fine_bin","zdistri_WFIRST_LSST_lensing_fine_bin"};
#ifdef ONESAMPLE
  char lens_zfile[2][400]={"zdistri_WFIRST_LSST_lensing_fine_bin","zdistri_WFIRST_LSST_lensing_fine_bin"};
...
#else
  char lens_zfile[2][400]={"zdistri_WFIRST_LSST_clustering_fine_bin","zdistri_WFIRST_LSST_clustering_fine_bin"};
#endif
