...
inv=['invcov_wfirstwidexso_k3x2pt','invcov_Y6_k3x2pt']

data=['k3x2pt_WFIRSTwidexSO5_dmo','k3x2pt_LSSTxSO_Y6_dmo']

bary=['LPC_k3x2pt_WFIRSTwidexSO5','LPC_k3x2pt_LSSTxSO_Y6']
...
chain_file = os.path.join(dirname, "chains/%s_k3x2pt_model" %survey_designation[model])
